...
export const noUnknownParametersRule = defineRule({
  ...
  createOnce(context) {
    const checkParameters = (node: ParameterOwner) => {
      // Explicit file-scoped exceptions cover actual raw I/O decoders/serializers.
      // Anonymous callbacks do not inherit their containing function's exception.
      const name = functionDeclarationName(node);
