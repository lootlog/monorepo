...
- Anulowanie zapisuje `CANCELLED` z nową rewizją jako 60-sekundowy tombstone, zwalnia indeksy i wysyła wyłącznie `REMOVE` z terminalną rewizją do organizatora oraz wszystkich dotychczasowych uczestników. Nie publikuje końcowej projekcji.
