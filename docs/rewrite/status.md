...
| API and Discord compatible slice                | in progress | Discord is complete; API source and E2E query layers are Prisma-free; the Effect/Bun composition root covers all 26 groups and 199 operations; request-scoped Traefik forward-auth, four identity-only ports, and nine Organization-aware authorization ports are wired; 194 protected and 5 public operations are preserved |
