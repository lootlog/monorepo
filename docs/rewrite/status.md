...
| API and Discord compatible slice                | in progress | Discord is complete; API source and E2E query layers are Prisma-free; one composed Effect HttpApi handler layer covers all 26 groups and 199 operations; request-scoped Traefik forward-auth preserves 194 protected and 5 public operations; 89 focused handler tests pass |
