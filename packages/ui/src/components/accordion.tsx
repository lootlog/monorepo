  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <ChevronDownIcon className="h-4 w-4 text-muted-foreground group-hover:text-primary transition-[color,rotate] duration-200 ease-emphasized group-aria-expanded:rotate-180 motion-reduce:transition-none" />
      </AccordionPrimitive.Trigger>
