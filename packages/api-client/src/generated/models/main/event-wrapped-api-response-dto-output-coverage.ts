 ...
 */
import type { EventWrappedApiResponseDtoOutputCoverageBestHeroCoverage } from './event-wrapped-api-response-dto-output-coverage-best-hero-coverage';
import type { EventWrappedApiResponseDtoOutputCoverageRoughestHeroCoverage } from './event-wrapped-api-response-dto-output-coverage-roughest-hero-coverage';
