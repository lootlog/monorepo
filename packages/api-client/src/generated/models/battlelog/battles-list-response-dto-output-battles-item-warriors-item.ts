 ...
 */
import type { BattlesListResponseDtoOutputBattlesItemWarriorsItemSpellsUsedMap } from './battles-list-response-dto-output-battles-item-warriors-item-spells-used-map';
