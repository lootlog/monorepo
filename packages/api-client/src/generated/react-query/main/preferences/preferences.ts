...
export const getSettingsDocumentsControllerPatchPreferencesMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof settingsDocumentsControllerPatchPreferences>>, TError,{data: BodyType<PatchSettingsDocumentsDto>}, TContext>, request?: SecondParameter<typeof mainFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof settingsDocumentsControllerPatchPreferences>>, TError,{data: BodyType<PatchSettingsDocumentsDto>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof settingsDocumentsControllerPatchPreferences>>, {data: BodyType<PatchSettingsDocumentsDto>}> = (props) => {
          const {data} = props ?? {};
...
export const useSettingsDocumentsControllerPatchPreferences = <TError = ErrorType<unknown>,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TError,
        {data: BodyType<PatchSettingsDocumentsDto>},
        TContext
      > => {
