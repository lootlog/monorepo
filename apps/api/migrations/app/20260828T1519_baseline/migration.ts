#!/usr/bin/env -S node
import type { Contract as End } from '../../snapshots/33926af930c3a6d02395b5c7f8a460a8b9039ac37841294514a77bb31c3eed62/contract';
import endContract from '../../snapshots/33926af930c3a6d02395b5c7f8a460a8b9039ac37841294514a77bb31c3eed62/contract.json' with { type: 'json' };
import {
  Migration,
  MigrationCLI,
  checkExpression,
  ...
  override get operations() {
    return [
      ...
      this.createNativeEnumType({
        ...
        members: ['PENDING', 'PROCESSING', 'SENT', 'FAILED', 'BLOCKED', 'CANCELED'],
      }),
      this.createNativeEnumType({
        schema: 'public',
      ...
      this.createNativeEnumType({
        ...
        members: ['TIMER_BEFORE_SPAWN', 'NPC_SPAWNED', 'WATCHED_ITEM_DROPPED', 'SCHEDULED_MESSAGE'],
      }),
      this.createNativeEnumType({
        schema: 'public',
        typeName: 'NpcType',
      ...
      this.createNativeEnumType({
        schema: 'public',
        typeName: 'Profession',
        members: ['WARRIOR', 'PALADIN', 'HUNTER', 'MAGE', 'BLADE_DANCER', 'TRACKER'],
      }),
      this.createNativeEnumType({
        schema: 'public',
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('grantedPermissions', 'text[]', { codecRef: { codecId: 'pg/text@1', many: true } }),
          ...
          col('missingPermissions', 'text[]', { codecRef: { codecId: 'pg/text@1', many: true } }),
          col('name', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('parentId', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('position', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('requiredPermissions', 'text[]', { codecRef: { codecId: 'pg/text@1', many: true } }),
          col('updatedAt', 'timestamp(3)', {
            notNull: true,
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          }),
        ],
        constraints: [primaryKey(['id'], { name: 'DiscordGuildChannelSnapshot_pkey' })],
      }),
      this.createTable({
        schema: 'public',
        ...
        columns: [
          ...
          col('status', '"DiscordGuildSyncStatus"', {
            notNull: true,
            default: lit('STALE'),
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'DiscordGuildSyncStatus' } },
          }),
          col('updatedAt', 'timestamp(3)', {
            notNull: true,
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
        ...
        constraints: [primaryKey(['guildId'], { name: 'DiscordGuildSyncState_pkey' })],
      }),
      this.createTable({
        schema: 'public',
        table: 'Event',
        columns: [
          ...
          col('mapAssignmentCap', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
          col('name', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          ...
          col('rulebookMarkdown', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('scoringMode', '"EventScoringMode"', {
            notNull: true,
            default: lit('SIMPLE'),
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'EventScoringMode' } },
          }),
          ...
          col('world', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
        ],
      ...
      this.createTable({
        ...
        table: 'EventHeroKill',
        columns: [
          col('heroNpcId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('id', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          ...
          col('timerCreatedById', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
        ],
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('npcName', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
        ],
      ...
      this.createTable({
        ...
        columns: [
          col('afkPercentage', 'float8', { notNull: true, codecRef: { codecId: 'pg/float8@1' } }),
          col('basePoints', 'float8', { notNull: true, codecRef: { codecId: 'pg/float8@1' } }),
          col('bonusBreakdown', 'jsonb', { codecRef: { codecId: 'pg/jsonb@1' } }),
          ...
          col('id', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('killId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('manualAdjustmentPoints', 'float8', {
            notNull: true,
            default: lit(0),
            codecRef: { codecId: 'pg/float8@1' },
          }),
          col('mapPresenceData', 'jsonb', { codecRef: { codecId: 'pg/jsonb@1' } }),
          col('memberId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('points', 'float8', { notNull: true, codecRef: { codecId: 'pg/float8@1' } }),
          col('timeOnMapSeconds', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('trackingDurationPercentage', 'float8', { codecRef: { codecId: 'pg/float8@1' } }),
          col('trackingDurationSeconds', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
          col('wasPresent', 'bool', { notNull: true, codecRef: { codecId: 'pg/bool@1' } }),
        ],
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('mapId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('mapName', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('updatedAt', 'timestamp(3)', {
            notNull: true,
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          }),
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('heroNpcId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('id', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('mapId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('memberId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('unassignedAt', 'timestamp(3)', {
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          }),
        ],
        constraints: [primaryKey(['id'], { name: 'EventMapAssignmentHistory_pkey' })],
      }),
      this.createTable({
        schema: 'public',
        ...
        columns: [
          ...
          col('gapType', '"CoverageGapType"', {
            notNull: true,
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'CoverageGapType' } },
          }),
          col('hadAssignedMembers', 'bool', { codecRef: { codecId: 'pg/bool@1' } }),
          col('heroNpcId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('id', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('mapId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('editType', '"PointsEditType"', {
            notNull: true,
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'PointsEditType' } },
          }),
          ...
          col('editedByUserId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('id', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('newPoints', 'float8', { notNull: true, codecRef: { codecId: 'pg/float8@1' } }),
          col('previousPoints', 'float8', { notNull: true, codecRef: { codecId: 'pg/float8@1' } }),
          col('rankingId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
        ],
        constraints: [primaryKey(['id'], { name: 'EventPointsEditHistory_pkey' })],
      }),
      this.createTable({
        schema: 'public',
        ...
        columns: [
          ...
          col('id', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('isAfk', 'bool', { notNull: true, codecRef: { codecId: 'pg/bool@1' } }),
          col('mapId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('memberId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('startedAt', 'timestamp(3)', {
            notNull: true,
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('eventId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('heroNpcName', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('id', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('manualAdjustmentPoints', 'float8', {
            notNull: true,
            default: lit(0),
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('gapsTimeline', 'jsonb', { notNull: true, codecRef: { codecId: 'pg/jsonb@1' } }),
          col('heroNpcId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('id', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('killId', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('mapStats', 'jsonb', { notNull: true, codecRef: { codecId: 'pg/jsonb@1' } }),
          col('maxSpawnTime', 'timestamp(3)', {
            notNull: true,
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          }),
          col('memberStats', 'jsonb', { notNull: true, codecRef: { codecId: 'pg/jsonb@1' } }),
          ...
          col('totalWindowSeconds', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
        ...
        constraints: [primaryKey(['id'], { name: 'EventRespawnWindowSummary_pkey' })],
      }),
      this.createTable({
        schema: 'public',
        table: 'Guild',
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('createdByMemberId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('deletedAt', 'timestamp(3)', {
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          }),
          col('deletedByMemberId', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('guildId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('id', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          ...
          col('updatedByMemberId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('version', 'int4', {
            notNull: true,
            default: lit(1),
            codecRef: { codecId: 'pg/int4@1' },
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('actorMemberId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('content', 'jsonb', { notNull: true, codecRef: { codecId: 'pg/jsonb@1' } }),
        ...
        constraints: [primaryKey(['id'], { name: 'GuildDocumentHistory_pkey' })],
      }),
      this.createTable({
        schema: 'public',
        ...
        columns: [
          ...
          col('npcIcon', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('npcId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('npcLvl', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('npcName', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('npcProf', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('npcType', '"NpcType"', {
            notNull: true,
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'NpcType' } },
          }),
      ...
      this.createTable({
        ...
        constraints: [primaryKey(['id'], { name: 'GuildKillSummaryBucket_pkey' })],
      }),
      this.createTable({
        schema: 'public',
        table: 'ItemSnapshot',
        columns: [
          ...
          col('rarity', '"ItemRarity"', {
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'ItemRarity' } },
          }),
          col('statRaw', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('statsHash', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('statsSnapshot', 'jsonb', { notNull: true, codecRef: { codecId: 'pg/jsonb@1' } }),
        ],
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('lootShareSource', '"LootShareSource"', {
            notNull: true,
            default: lit('NONE'),
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'LootShareSource' } },
          }),
          col('source', '"LootSource"', {
            notNull: true,
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'LootSource' } },
          }),
          col('uniqueId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('updatedAt', 'timestamp(3)', {
            notNull: true,
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          }),
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('guildId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('id', 'SERIAL', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('lootId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('memberId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('updatedAt', 'timestamp(3)', {
            notNull: true,
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
      ...
      this.createTable({
        ...
        table: 'LootItem',
        columns: [
          col('hid', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('id', 'SERIAL', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('itemSnapshotId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('lootId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
        ],
      ...
      this.createTable({
        ...
        columns: [
          col('id', 'SERIAL', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('lootId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('npcSnapshotId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
        ],
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('lootId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('lvl', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
          col('playerSnapshotId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
        ],
      ...
      this.createTable({
        ...
        columns: [
          col('allowedRarities', '"ItemRarity"[]', {
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'ItemRarity' }, many: true },
          }),
          col('createdAt', 'timestamp(3)', {
            notNull: true,
            default: fn('now()'),
          ...
          col('id', 'SERIAL', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('lootlogConfigId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('npcType', '"NpcType"', {
            notNull: true,
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'NpcType' } },
          }),
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('guildId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('id', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('maps', 'jsonb', { notNull: true, codecRef: { codecId: 'pg/jsonb@1' } }),
          col('name', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
        ],
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('lastDiscordStatus', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          ...
          col('type', '"MemberType"', {
            notNull: true,
            default: lit('USER'),
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'MemberType' } },
          }),
          col('updatedAt', 'timestamp(3)', {
            notNull: true,
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('status', '"RefreshJobStatus"', {
            notNull: true,
            default: lit('PENDING'),
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'RefreshJobStatus' } },
          }),
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('jobKind', '"NotificationJobKind"', {
            notNull: true,
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'NotificationJobKind' } },
          }),
          col('lastError', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('ownerId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('ownerType', '"NotificationOwnerType"', {
            notNull: true,
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'NotificationOwnerType' } },
          }),
          col('payloadSnapshot', 'jsonb', { notNull: true, codecRef: { codecId: 'pg/jsonb@1' } }),
          col('processedAt', 'timestamp(3)', {
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          }),
          col('providerMessageId', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('ruleId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('scheduledFor', 'timestamp(3)', {
            notNull: true,
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          }),
          col('sourceEntityId', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('sourceEntityType', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('sourceEventId', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('status', '"NotificationJobStatus"', {
            notNull: true,
            default: lit('PENDING'),
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'NotificationJobStatus' } },
          }),
      ...
      this.createTable({
        ...
        columns: [
          col('contentTemplate', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('createdAt', 'timestamp(3)', {
            notNull: true,
            default: fn('now()'),
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          ...
          col('scheduleIntervalValue', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
          col('scheduleOffsetMinutes', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
          ...
          col('scheduleTimeOfDay', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('scheduleTimezone', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('scheduleWeekday', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
          ...
          col('triggerType', '"NotificationTriggerType"', {
            notNull: true,
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'NotificationTriggerType' } },
          }),
          col('updatedAt', 'timestamp(3)', {
            notNull: true,
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
      ...
      this.createTable({
        ...
        constraints: [primaryKey(['ruleId', 'targetId'], { name: 'NotificationRuleTarget_pkey' })],
      }),
      this.createTable({
        schema: 'public',
        ...
        columns: [
          ...
          col('lastDeliveryError', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('lastSyncedAt', 'timestamp(3)', {
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          }),
          ...
          col('provider', '"NotificationProvider"', {
            notNull: true,
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'NotificationProvider' } },
          }),
          col('targetType', '"NotificationTargetType"', {
            notNull: true,
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'NotificationTargetType' } },
          }),
          col('updatedAt', 'timestamp(3)', {
            notNull: true,
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('npcId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('prof', '"Profession"', {
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'Profession' } },
          }),
          col('type', '"NpcType"', {
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'NpcType' } },
          }),
      ...
      this.createTable({
        ...
        table: 'Reservation',
        columns: [
          col('authorAvatarUrl', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('authorDisplayName', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('comment', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('createdAt', 'timestamp(3)', {
            notNull: true,
            default: fn('now()'),
          ...
          col('createdByUserId', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          ...
          col('guildId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('id', 'SERIAL', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('reminderMinutesBefore', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
          col('reservationId', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('spotId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('spotName', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('startsAt', 'timestamp(3)', {
            notNull: true,
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          }),
        ...
        constraints: [
          ...
          checkExpression('Reservation_valid_time_range_check', '("endsAt" > "startsAt")'),
        ],
      }),
      this.createTable({
        schema: 'public',
        ...
        columns: [
          col('acceptedByUserId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('createdAt', 'timestamp(3)', {
            notNull: true,
            default: fn('now()'),
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          ...
          col('firstGuildId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('id', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('revokedAt', 'timestamp(3)', {
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          }),
          col('secondGuildId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('updatedAt', 'timestamp(3)', {
            notNull: true,
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          }),
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('sourceGuildId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
        ...
        constraints: [primaryKey(['id'], { name: 'ReservationShareInvitation_pkey' })],
      }),
      this.createTable({
        schema: 'public',
        table: 'Role',
        columns: [
          ...
          col('guildId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('id', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('lvlRangeFrom', 'int4', { default: lit(0), codecRef: { codecId: 'pg/int4@1' } }),
          col('lvlRangeTo', 'int4', { default: lit(500), codecRef: { codecId: 'pg/int4@1' } }),
          col('name', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('permissions', '"Permission"[]', {
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'Permission' }, many: true },
          }),
      ...
      this.createTable({
        ...
        table: 'Timer',
        columns: [
          col('actorCharacterLvl', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
          col('actorCharacterSnapshotId', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
          col('createdAt', 'timestamp(3)', {
            notNull: true,
            default: fn('now()'),
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          ...
          col('npc', 'jsonb', { notNull: true, codecRef: { codecId: 'pg/jsonb@1' } }),
          col('npcId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('tempId', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('timerKey', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('updatedAt', 'timestamp(3)', {
            notNull: true,
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          }),
        ...
        constraints: [primaryKey(['guildId', 'world', 'timerKey'], { name: 'Timer_pkey' })],
      }),
      this.createTable({
        schema: 'public',
        ...
        columns: [
          col('action', '"TimerHistoryAction"', {
            notNull: true,
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'TimerHistoryAction' } },
          }),
          col('actorCharacterLvl', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
          col('actorCharacterSnapshotId', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
          col('actorMemberId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('createdAt', 'timestamp(3)', {
            notNull: true,
            default: fn('now()'),
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          ...
          col('guildId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('id', 'SERIAL', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('latestRespBaseSeconds', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
          col('latestRespawnRandomness', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
          col('maxSpawnTime', 'timestamp(3)', {
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          }),
          col('minSpawnTime', 'timestamp(3)', {
          ...
          col('npc', 'jsonb', { notNull: true, codecRef: { codecId: 'pg/jsonb@1' } }),
          col('npcId', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('timerActorCharacterLvl', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
          col('timerActorCharacterSnapshotId', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
          col('timerCreatedById', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
          col('timerKey', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
      ...
      this.createTable({
        ...
        constraints: [primaryKey(['id'], { name: 'UserCharactersLootlogSettings_pkey' })],
      }),
      this.createTable({
        schema: 'public',
        ...
        constraints: [primaryKey(['id'], { name: 'UserGameAccountSettings_pkey' })],
      }),
      this.createTable({
        schema: 'public',
        ...
        columns: [
          ...
          col('guildId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('hiddenTimers', 'text[]', { codecRef: { codecId: 'pg/text@1', many: true } }),
          col('id', 'SERIAL', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('pinnedTimers', 'text[]', { codecRef: { codecId: 'pg/text@1', many: true } }),
          col('updatedAt', 'timestamp(3)', {
            notNull: true,
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          }),
        ...
        constraints: [primaryKey(['id'], { name: 'UserGuildTimerSettings_pkey' })],
      }),
      this.createTable({
        schema: 'public',
        table: 'UserKillStats',
      ...
      this.createTable({
        ...
        constraints: [primaryKey(['id'], { name: 'UserPinnedReservationSpot_pkey' })],
      }),
      this.createTable({
        schema: 'public',
        ...
        columns: [
          ...
          col('scopeId', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('scopeType', '"SettingsScopeType"', {
            notNull: true,
            codecRef: { codecId: 'pg/enum@1', typeParams: { typeName: 'SettingsScopeType' } },
          }),
          col('updatedAt', 'timestamp(3)', {
            notNull: true,
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('guildsOrder', 'text[]', { codecRef: { codecId: 'pg/text@1', many: true } }),
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('customColors', 'jsonb', { notNull: true, codecRef: { codecId: 'pg/jsonb@1' } }),
          col('defaultColorNames', 'jsonb', { notNull: true, codecRef: { codecId: 'pg/jsonb@1' } }),
          col('displayConfig', 'jsonb', { notNull: true, codecRef: { codecId: 'pg/jsonb@1' } }),
          col('generalConfig', 'jsonb', { notNull: true, codecRef: { codecId: 'pg/jsonb@1' } }),
          ...
          col('timersColors', 'jsonb', { notNull: true, codecRef: { codecId: 'pg/jsonb@1' } }),
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('notificationRuleId', 'int4', { codecRef: { codecId: 'pg/int4@1' } }),
          col('updatedAt', 'timestamp(3)', {
            notNull: true,
            codecRef: { codecId: 'pg/timestamp-temporal@1', typeParams: { precision: 3 } },
          }),
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('B', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
        ],
        constraints: [primaryKey(['A', 'B'], { name: '_EventMapToMember_AB_pkey' })],
      }),
      this.createTable({
        schema: 'public',
        table: '_MemberToRole',
        columns: [
          col('A', 'int4', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('B', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
        ],
        constraints: [primaryKey(['A', 'B'], { name: '_MemberToRole_AB_pkey' })],
      }),
      this.createIndex({
        schema: 'public',
        table: 'DiscordGuildChannelSnapshot',
      ...
      this.createIndex({
        schema: 'public',
        table: 'LootComment',
        index: 'LootComment_lootId_guildId_idx',
        columns: ['lootId', 'guildId'],
      }),
      this.createIndex({
        schema: 'public',
        table: 'LootComment',
        index: 'LootComment_lootId_idx',
        columns: ['lootId'],
      }),
      this.createIndex({
        schema: 'public',
      ...
      this.createIndex({
        schema: 'public',
        table: 'LootSubmission',
        index: 'LootSubmission_guildId_lootId_idx',
        columns: ['guildId', 'lootId'],
      }),
      this.createIndex({
        schema: 'public',
        table: 'LootSubmission',
        index: 'LootSubmission_lootId_guildId_memberId_key',
        columns: ['lootId', 'guildId', 'memberId'],
        extras: { unique: true },
      }),
      this.createIndex({
        schema: 'public',
      ...
      this.createIndex({
        schema: 'public',
        table: 'NotificationTarget',
        index: 'NotificationTarget_ownerType_ownerId_provider_targetType_ex_key',
        columns: ['ownerType', 'ownerId', 'provider', 'targetType', 'externalId'],
        extras: { unique: true },
      }),
      this.createIndex({
        schema: 'public',
      ...
      this.createIndex({
        schema: 'public',
        table: 'NpcKillStatsBucket',
        index: 'NpcKillStatsBucket_guildId_memberId_world_npcId_periodStart_key',
      ...
      this.addForeignKey({
        ...
        foreignKey: {
          ...
          columns: ['heroNpcId'],
          references: { schema: 'public', table: 'EventHeroNpc', columns: ['id'] },
          onDelete: 'cascade',
          onUpdate: 'cascade',
        },
      }),
      ...
      this.addForeignKey({
        ...
        foreignKey: {
          ...
          columns: ['killId'],
          references: { schema: 'public', table: 'EventHeroKill', columns: ['id'] },
          onDelete: 'cascade',
          onUpdate: 'cascade',
        },
      }),
      ...
      this.addForeignKey({
        ...
        foreignKey: {
          ...
          columns: ['locationId'],
          references: { schema: 'public', table: 'EventMapLocation', columns: ['id'] },
          onDelete: 'setNull',
          onUpdate: 'cascade',
        },
      }),
      ...
      this.addForeignKey({
        ...
        foreignKey: {
          ...
          columns: ['rankingId'],
          references: { schema: 'public', table: 'EventRanking', columns: ['id'] },
          onDelete: 'cascade',
          onUpdate: 'cascade',
        },
      }),
      ...
      this.addForeignKey({
        ...
        foreignKey: {
          ...
          columns: ['documentId'],
          references: { schema: 'public', table: 'GuildDocument', columns: ['id'] },
          onDelete: 'cascade',
          onUpdate: 'cascade',
        },
      }),
      ...
      this.addForeignKey({
        ...
        foreignKey: {
          ...
          references: { schema: 'public', table: 'ItemSnapshot', columns: ['id'] },
          onDelete: 'restrict',
          onUpdate: 'cascade',
        },
      }),
      ...
      this.addForeignKey({
        ...
        foreignKey: {
          ...
          columns: ['npcSnapshotId'],
          references: { schema: 'public', table: 'NpcSnapshot', columns: ['id'] },
          onDelete: 'restrict',
          onUpdate: 'cascade',
        },
      }),
      ...
      this.addForeignKey({
        ...
        foreignKey: {
          ...
          columns: ['playerSnapshotId'],
          references: { schema: 'public', table: 'PlayerSnapshot', columns: ['id'] },
          onDelete: 'restrict',
          onUpdate: 'cascade',
        },
      }),
      this.addForeignKey({
        ...
        table: 'LootSubmission',
        foreignKey: {
          name: 'LootSubmission_guildId_fkey',
          columns: ['guildId'],
          references: { schema: 'public', table: 'Guild', columns: ['id'] },
          onDelete: 'restrict',
          onUpdate: 'cascade',
      ...
      this.addForeignKey({
        ...
        table: 'LootSubmission',
        foreignKey: {
          name: 'LootSubmission_lootId_fkey',
          columns: ['lootId'],
          references: { schema: 'public', table: 'Loot', columns: ['id'] },
          onDelete: 'restrict',
          onUpdate: 'cascade',
      ...
      this.addForeignKey({
        ...
        foreignKey: {
          ...
          references: { schema: 'public', table: 'LootlogConfig', columns: ['id'] },
          onDelete: 'restrict',
          onUpdate: 'cascade',
        },
      }),
      ...
      this.addForeignKey({
        ...
        foreignKey: {
          ...
          columns: ['ruleId'],
          references: { schema: 'public', table: 'NotificationRule', columns: ['id'] },
          onDelete: 'cascade',
          onUpdate: 'cascade',
        },
      }),
      this.addForeignKey({
        ...
        foreignKey: {
          ...
          columns: ['targetId'],
          references: { schema: 'public', table: 'NotificationTarget', columns: ['id'] },
          onDelete: 'cascade',
          onUpdate: 'cascade',
        },
      }),
      ...
      rawSql({
        ...
        execute: [
          {
            description: 'restore defaults which Prisma 8 RC cannot express for nullable arrays',
      ...
      rawSql({
        id: 'Reservation.rollout-bridge',
        label: 'Create reservation rollout compatibility bridge',
        operationClass: 'additive',
        target: {
          id: 'postgres',
          details: { schema: 'public', objectType: 'table', name: 'Reservation' },
        },
        precheck: [],
        execute: [
          {
            description: 'create the reservation rollout trigger function and trigger',
