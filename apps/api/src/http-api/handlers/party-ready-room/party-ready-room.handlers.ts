...
import type { ReadyRoomService } from "#src/messaging/ready-room/ready-room.service";
import {
  LootlogApi,
...
const readyRoomPermissions: ReadonlyArray<PermissionValue> = [
