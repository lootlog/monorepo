...
import { HeroRespawnConfigResponse } from "#src/events/monitoring/event-monitoring-response.schema";
...
import type { EventRespawnStore } from "#src/events/respawn/event-respawn.repository";
