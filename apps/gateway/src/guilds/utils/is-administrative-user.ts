...
const ADMIN_PERMISSIONS = [Permission.ADMIN, Permission.OWNER] as const;
...
export const isAdministrativeUser = (permissions: Permission[]) => {
  return hasAnyPermission(permissions, ADMIN_PERMISSIONS);
};
...
export const isOwnerOrAdmin = isAdministrativeUser;

export const isOwnerOrAdminFromRoles = isAdministrativeUserFromRoles;
