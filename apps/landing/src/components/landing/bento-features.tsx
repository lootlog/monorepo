        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-1.5 flex-wrap">
            <div className="h-4 w-full bg-purple-500/10 border border-purple-500/30 rounded text-[8px] text-purple-400 flex items-center px-1.5">
              {t("landing.bento.visual.legendary")}
            </div>
      ...
      >
        ...
        <div className="space-y-1">
          <div className="text-[10px] font-bold text-green-400 uppercase tracking-wide">
            {t("landing.bento.visual.respawn")}
          </div>
          <div className="text-xs text-gray-300 leading-tight">
            <span className="text-white font-medium">
              {t("landing.bento.visual.titan")}
            </span>{" "}
            {t("landing.bento.visual.respawnMessage")}
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="space-y-1">
          <div className="text-[10px] font-bold text-blue-400 uppercase tracking-wide">
            {t("landing.bento.visual.auction")}
          </div>
          <div className="text-xs text-gray-400 leading-tight">
            {t("landing.bento.visual.auctionMessage")}
          </div>
        </div>
      </motion.div>
    </div>
      ...
      <div className="flex gap-2 items-end">
        ...
        >
          <div className="text-[10px] text-gray-300">
            {t("landing.bento.visual.chatMessage1")}
          </div>
        </motion.div>
      </div>
      ...
      <div className="flex gap-2 items-end flex-row-reverse">
        ...
        >
          <div className="text-[10px] text-primary-foreground">
            {t("landing.bento.visual.chatMessage2")}
          </div>
        </motion.div>
      </div>
  ...
  return (
    <div className="p-4 grid grid-cols-3 gap-2">
      {[...Array(6)].map((_, i) => (
        ...
        >
          {i === 1
            ? t("landing.bento.visual.occupied")
            : i === 4
              ? t("landing.bento.visual.you")
              : t("landing.bento.visual.free")}
        </div>
      ))}
    </div>
  );
  ...
  return (
    <div className="py-24">
      <div className="text-center mb-20 space-y-4">
        <h2 className="text-4xl md:text-6xl font-black tracking-tighter text-foreground">
          ...
          <span className="text-primary">
            {t("landing.bento.titleHighlight")}
          </span>
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-7xl mx-auto px-4 auto-rows-[200px]">
        <BentoCard
          title={t("landing.bento.timers.title")}
          description={t("landing.bento.timers.description")}
          className="md:col-span-1 md:row-span-2"
          visual=<TimersVisual />
        />

        <BentoCard
          title={t("landing.bento.loot.title")}
          description={t("landing.bento.loot.description")}
          className="md:col-span-2 md:row-span-1"
          visual=<LootVisual />
        />

        <BentoCard
          title={t("landing.bento.notifications.title")}
          description={t("landing.bento.notifications.description")}
          className="md:col-span-1 md:row-span-1"
          visual=<NotificationVisual />
        />

        <BentoCard
          title={t("landing.bento.battles.title")}
          description={t("landing.bento.battles.description")}
          className="md:col-span-1 md:row-span-1"
          visual=<BattleVisual />
        />

        <BentoCard
          title={t("landing.bento.chat.title")}
          description={t("landing.bento.chat.description")}
          className="md:col-span-2 md:row-span-1"
          visual=<ChatVisual />
        />

        <BentoCard
          title={t("landing.bento.reservations.title")}
          description={t("landing.bento.reservations.description")}
          className="md:col-span-1 md:row-span-1"
