...
import * as d_docs_4 from "../content/docs/installation.mdx?collection=docs";
import * as d_docs_3 from "../content/docs/index.mdx?collection=docs";
import * as d_docs_2 from "../content/docs/getting-started.mdx?collection=docs";
import * as d_docs_1 from "../content/docs/features.mdx?collection=docs";
import * as d_docs_0 from "../content/docs/faq.mdx?collection=docs";
