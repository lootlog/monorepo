  ...
  override get operations() {
    return [
      ...
      this.createTable({
        ...
        columns: [
          ...
          col("source", '"ActivitySource"', {
            ...
            codecRef: {
              codecId: "pg/enum@1",
              typeParams: { typeName: "ActivitySource" },
            },
          }),
          col("type", '"ActivityType"', {
            ...
            codecRef: {
              codecId: "pg/enum@1",
              typeParams: { typeName: "ActivityType" },
            },
          }),
          col("userId", "text", {
            notNull: true,
        ...
        constraints: [
          primaryKey(["id", "createdAt"], { name: "Activity_pkey" }),
        ],
      }),
      this.createTable({
        schema: "public",
        ...
        constraints: [
          primaryKey(["id"], { name: "ActivityActorSnapshot_pkey" }),
        ],
      }),
      this.createTable({
        schema: "public",
      ...
      this.createTable({
        ...
        constraints: [
          primaryKey(["guildId", "discordId", "source"], {
      ...
      rawSql({
        ...
        execute: [
          {
            description: "Convert Activity to a one-day TimescaleDB hypertable",
  ...
  WHERE hypertable_schema = 'public'
    AND hypertable_name = 'Activity'
      ...
      rawSql({
        ...
        execute: [
          {
            description: "Retain seven days of Activity data",
