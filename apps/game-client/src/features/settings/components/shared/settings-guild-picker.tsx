...
const SettingsGuildPickerItem: FC<SettingsGuildPickerItemProps> = ({
  ...
  <SettingsPickerCard
    ...
    trailing={
      <span
        aria-hidden
        className="ll:flex ll:size-4 ll:shrink-0 ll:items-center ll:justify-center ll:rounded-full ll:bg-emerald-500 ll:text-white ll:scale-50 ll:opacity-0 ll:transition-[opacity,transform] ll:duration-200 ll:ease-[cubic-bezier(0.2,0,0,1)] ll:group-data-pressed/picker-card:scale-100 ll:group-data-pressed/picker-card:opacity-100"
      >
