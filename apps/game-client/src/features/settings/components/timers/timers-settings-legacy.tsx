...
/** Settings that only the classic (legacy) timers layout reads. */
export const TimersSettingsLegacy: FC = () => {
  ...
  return (
    <SettingsTabLayout>
      <SettingsSection
        controlId="timer-legacy-behavior"
        title={t("timers:legacySettings.title")}
        description={t("timers:legacySettings.description")}
      >
        <SettingsRow
        ...
        >
          <Switch
            ...
            onCheckedChange={(value) =>
              setTimerGeneralConfig({ ...generalConfig, compactView: value })
            }
            id="compact-view"
          />
        </SettingsRow>
