  ...
  return (
    <AnimatedWindow isOpen={open} windowKey="backend-preferences-warning">
      <DraggableWindow
        ...
        title={t("settings.backendPreferencesWarning.title")}
        onClose={handleClose}
        variant="small"
        resizable={false}
      ...
      >
        <div className="ll:flex ll:flex-col ll:gap-4 ll:p-4">
          <div className="ll:text-sm ll:text-gray-200">
            <p className="ll:mb-3">
              {t("settings.backendPreferencesWarning.summary")}
            </p>
            <p>{t("settings.backendPreferencesWarning.details")}</p>
          </div>
          <div className="ll:flex ll:justify-end ll:gap-2">
            <Button onClick={handleClose} className="ll:px-3 ll:py-1">
              {t("settings.backendPreferencesWarning.close")}
            </Button>
            <Button onClick={handleOpenSettings} className="ll:px-3 ll:py-1">
              {t("settings.backendPreferencesWarning.openSettings")}
            </Button>
          </div>
        </div>
      </DraggableWindow>
