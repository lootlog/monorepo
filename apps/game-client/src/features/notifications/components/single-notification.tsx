...
export const SingleNotification: FC<SingleNotificationProps> = ({
  ...
  const senderName =
    guildMember?.name ?? t("settings.notifications.runtime.unknownSender");
  ...
  if (showPartyGatheringAction) {
    actionLabel = volunteer.isPending
      ? t("settings.notifications.runtime.joinPending")
      : t("settings.notifications.runtime.join");
  }
      ...
      >
        ...
        <div className="ll:flex ll:shrink-0 ll:items-center ll:gap-1">
          ...
          {showJoinAction ? (
            <Button
              variant="ghost"
              aria-label={t("settings.notifications.runtime.joinAria")}
          ...
          {showCloseButton ? (
            <Button
              variant="destructive"
              aria-label={t("settings.notifications.runtime.closeAria")}
              className="ll:size-7 ll:px-0"
