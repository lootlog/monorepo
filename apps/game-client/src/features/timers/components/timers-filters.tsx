  ...
  return (
    <div className="ll:flex ll:flex-col ll:gap-1 ll:mb-1">
      <div className="ll:flex ll:flex-row ll:gap-1 ll:flex-nowrap">
        <Input
          placeholder={t("settings.timers.filters.searchPlaceholder")}
          value={timerFiltersSearchText}
          onChange={handleSearchChange}
        />
        <div className="ll:w-18">
          <Input
            placeholder={t("settings.timers.filters.minPlaceholder")}
        ...
        <div className="ll:w-18">
          <Input
            placeholder={t("settings.timers.filters.maxPlaceholder")}
