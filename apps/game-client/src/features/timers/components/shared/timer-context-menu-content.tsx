...
import type { TimerAccess } from "@/features/timers/hooks/use-timer-access-policies";
...
import { TimerHistoryMenuItem } from "./timer-history-menu-item";
...
type TimerContextMenuContentProps = {
  ...
  access: Pick<TimerAccess, "policiesByGuildId" | "guildNamesById">;
  ...
  return (
    <>
      <TimerColorPicker
        ...
        defaultColorNames={colors.defaultColorNames}
        overriddenDefaultColors={colors.overriddenDefaultColors}
        hiddenDefaultColors={colors.hiddenDefaultColors}
      ...
      {showHistory && <TimerHistoryMenuItem timer={timer} />}
      {timersGrouping ? (
        <DeleteTimerPopover
          timer={timer}
          policiesByGuildId={access.policiesByGuildId}
          guildNamesById={access.guildNamesById}
