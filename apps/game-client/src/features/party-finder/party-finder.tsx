...
export const PartyFinder = () => {
  ...
  return (
    <AnimatedWindow isOpen={open && !!partyGathering} windowKey="party-finder">
      <DraggableWindow
        id="party-finder"
        title={t("party-finder.window.title")}
        ...
        <div className="ll:flex ll:flex-col ll:h-full">
          ...
          {isOwner && (
            <div className="ll:shrink-0 ll:p-2 ll:border-t ll:border-gray-700 ll:flex ll:flex-col ll:gap-1.5">
                ...
                >
                  {isInvitingAll ? (
                    <>
                      ...
                      {t("party-finder.actions.inviting")}
                    </>
                  ) : (
                    t("party-finder.actions.inviteAll")
                  )}
                </Button>
              )}
              <Button
              ...
              >
                {isCancelling
                  ? t("party-finder.actions.ending")
                  : t("party-finder.actions.endGathering")}
              </Button>
            </div>
          )}
        </div>
