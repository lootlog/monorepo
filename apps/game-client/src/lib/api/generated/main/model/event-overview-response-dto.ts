 ...
 */
import type { EventOverviewResponseDtoHeroNpcsItem } from './event-overview-response-dto-hero-npcs-item.js';
import type { EventOverviewResponseDtoSchema0 } from './event-overview-response-dto-schema0.js';
import type { EventOverviewResponseDtoScoringMode } from './event-overview-response-dto-scoring-mode.js';
...
export interface EventOverviewResponseDto {
  ...
  scoringRules: (EventOverviewResponseDtoSchema0 | null) | null;
