 ...
 */
import type { EventMutationResponseDtoHeroNpcsItem } from './event-mutation-response-dto-hero-npcs-item.js';
import type { EventMutationResponseDtoSchema0 } from './event-mutation-response-dto-schema0.js';
import type { EventMutationResponseDtoScoringMode } from './event-mutation-response-dto-scoring-mode.js';
...
export interface EventMutationResponseDto {
  ...
  scoringRules: (EventMutationResponseDtoSchema0 | null) | null;
