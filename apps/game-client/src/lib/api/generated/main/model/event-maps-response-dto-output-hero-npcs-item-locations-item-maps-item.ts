 ...
 */
import type { EventMapsResponseDtoOutputHeroNpcsItemLocationsItemMapsItemAssignedMembersItem } from './event-maps-response-dto-output-hero-npcs-item-locations-item-maps-item-assigned-members-item.js';
