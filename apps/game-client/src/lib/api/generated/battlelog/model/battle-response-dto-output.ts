 ...
 */
import type { BattleResponseDtoOutputStatistics } from './battle-response-dto-output-statistics.js';
import type { BattleResponseDtoOutputWarriorsItem } from './battle-response-dto-output-warriors-item.js';
