...
const BACKGROUND_COLORS_BY_KEY = {
...
const isNotificationColorKey = (
  key: string,
): key is keyof typeof TEXT_COLORS_BY_KEY =>
  Object.hasOwn(TEXT_COLORS_BY_KEY, key);
