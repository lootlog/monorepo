    ...
    const renderOptions = (opts: ComboboxOption[]) => {
      return opts.map((option) => (
        <CommandItem
          ...
          className="ll:relative ll:data-[selected=true]:bg-gray-400/30 ll:h-6 ll:transition-all ll:cursor-default ll:select-none ll:box-border ll:border-gray-400 ll:border-solid ll:border ll:items-center ll:text-white ll:text-[11px] ll:bg-transparent ll:rounded-sm ll:py-1.5 ll:pl-2 ll:pr-8"
        >
              ...
              {groups.length > 0 ? (
                groups.map((group, index) => (
                  <React.Fragment key={index}>
                    <CommandGroup
                      heading={group.label}
                      className="ll:text-gray-400 ll:mt-1 ll:text-[10px] ll:font-sans [&_[cmdk-group-heading]]:ll:text-[10px] [&_[cmdk-group-heading]]:ll:font-semibold [&_[cmdk-group-heading]]:ll:text-gray-300 [&_[cmdk-group-heading]]:ll:pl-3 [&_[cmdk-group-heading]]:ll:pr-2 [&_[cmdk-group-heading]]:ll:py-1"
                    >
