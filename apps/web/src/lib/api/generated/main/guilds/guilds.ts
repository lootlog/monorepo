 ...
 */
export const guildsControllerGetUserGuilds = async (params?: GuildsControllerGetUserGuildsParams, options?: RequestInit): Promise<UserGuildListResponseDtoOutput[]> => {

  return orvalFetch<UserGuildListResponseDtoOutput[]>(getGuildsControllerGetUserGuildsUrl(params),
  {
    ...options,
    method: 'GET'
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGuildsControllerGetGuildByIdQueryKey({ guildId });
   ...
   return  { queryKey, queryFn, enabled: guildId !== null && guildId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof guildsControllerGetGuildById>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGuildsControllerGetGuildConfigQueryKey({ guildId });
   ...
   return  { queryKey, queryFn, enabled: guildId !== null && guildId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof guildsControllerGetGuildConfig>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGuildsControllerGetWorldsByGuildIdQueryKey({ guildId });
   ...
   return  { queryKey, queryFn, enabled: guildId !== null && guildId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof guildsControllerGetWorldsByGuildId>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGuildsControllerGetGuildPermissionsQueryKey({ guildId });
   ...
   return  { queryKey, queryFn, enabled: guildId !== null && guildId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof guildsControllerGetGuildPermissions>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGuildsControllerGetGuildDiscordSyncStatusQueryKey({ guildId });
   ...
   return  { queryKey, queryFn, enabled: guildId !== null && guildId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof guildsControllerGetGuildDiscordSyncStatus>>, TError, TData> & { queryKey: QueryKey }
}
