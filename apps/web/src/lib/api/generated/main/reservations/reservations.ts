...
export const reservationsControllerGetReservations = async ({ guildId }: ReservationsControllerGetReservationsPathParameters, options?: RequestInit): Promise<void> => {

  return orvalFetch<void>(getReservationsControllerGetReservationsUrl({ guildId }),
  {
    ...options,
    method: 'GET'
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getReservationsControllerGetReservationsQueryKey({ guildId });
   ...
   return  { queryKey, queryFn, enabled: !!(guildId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof reservationsControllerGetReservations>>, TError, TData> & { queryKey: QueryKey }
}
...
export const useSetReservationsControllerGetReservationsQueryData = () => {
  ...
  return ({ guildId }: ReservationsControllerGetReservationsPathParameters,updater: Awaited<ReturnType<typeof reservationsControllerGetReservations>> | undefined | ((old: Awaited<ReturnType<typeof reservationsControllerGetReservations>> | undefined) => Awaited<ReturnType<typeof reservationsControllerGetReservations>> | undefined)) => {
    queryClient.setQueryData(getReservationsControllerGetReservationsQueryKey({ guildId }), updater);
  };
}
...
export const reservationsControllerCreateReservation = async ({ guildId }: ReservationsControllerCreateReservationPathParameters,
    createReservationDto: CreateReservationDto, options?: RequestInit): Promise<void> => {

  return orvalFetch<void>(getReservationsControllerCreateReservationUrl({ guildId }),
  {
    ...options,
    method: 'POST',
...
export const reservationsControllerDeleteReservation = async ({ guildId, reservationRecordId }: ReservationsControllerDeleteReservationPathParameters, options?: RequestInit): Promise<void> => {

  return orvalFetch<void>(getReservationsControllerDeleteReservationUrl({ guildId, reservationRecordId }),
  {
    ...options,
    method: 'DELETE'
...
export const reservationsControllerGetReservationsCards = async ({ guildId }: ReservationsControllerGetReservationsCardsPathParameters, options?: RequestInit): Promise<void> => {

  return orvalFetch<void>(getReservationsControllerGetReservationsCardsUrl({ guildId }),
  {
    ...options,
    method: 'GET'
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getReservationsControllerGetReservationsCardsQueryKey({ guildId });
   ...
   return  { queryKey, queryFn, enabled: !!(guildId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof reservationsControllerGetReservationsCards>>, TError, TData> & { queryKey: QueryKey }
}
...
export const useSetReservationsControllerGetReservationsCardsQueryData = () => {
  ...
  return ({ guildId }: ReservationsControllerGetReservationsCardsPathParameters,updater: Awaited<ReturnType<typeof reservationsControllerGetReservationsCards>> | undefined | ((old: Awaited<ReturnType<typeof reservationsControllerGetReservationsCards>> | undefined) => Awaited<ReturnType<typeof reservationsControllerGetReservationsCards>> | undefined)) => {
    queryClient.setQueryData(getReservationsControllerGetReservationsCardsQueryKey({ guildId }), updater);
  };
}
