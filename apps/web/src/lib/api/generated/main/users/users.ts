...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getUsersControllerGetUserGameAccountPreferencesQueryKey({ accountId });
   ...
   return  { queryKey, queryFn, enabled: accountId !== null && accountId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof usersControllerGetUserGameAccountPreferences>>, TError, TData> & { queryKey: QueryKey }
}
