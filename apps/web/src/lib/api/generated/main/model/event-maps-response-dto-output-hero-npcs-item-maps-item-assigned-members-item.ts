 ...
 */
import type { EventMapsResponseDtoOutputHeroNpcsItemMapsItemAssignedMembersItemRolesItem } from './event-maps-response-dto-output-hero-npcs-item-maps-item-assigned-members-item-roles-item';
