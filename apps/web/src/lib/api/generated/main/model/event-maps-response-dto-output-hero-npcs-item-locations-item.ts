 ...
 */
import type { EventMapsResponseDtoOutputHeroNpcsItemLocationsItemMapsItem } from './event-maps-response-dto-output-hero-npcs-item-locations-item-maps-item.js';
