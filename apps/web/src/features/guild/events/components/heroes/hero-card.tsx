  ...
  return (
    <div className="relative group">
      <Link
        ...
        className="block"
      >
        <Card className="bg-card border-border hover:bg-card hover:border-primary/30 transition-colors cursor-pointer group-hover:border-primary/30 gap-0 py-2 pl-2 pr-2">
