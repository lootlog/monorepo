    ...
    <div className="space-y-8 p-6 overflow-y-auto h-full">
      ...
      <div className="space-y-6">
        <div className="space-y-3">
          <Label className="text-lg font-semibold">Tryb</Label>
