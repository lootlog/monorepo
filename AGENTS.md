...
- When writing Effect code, first read `repos/effect/LLMS.md`, then inspect
  `repos/effect/` for examples of idiomatic usage, tests, module structure, and
  API design. Treat it as the source of truth for Effect patterns.
